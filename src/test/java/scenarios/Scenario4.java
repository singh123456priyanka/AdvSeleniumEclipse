...
import POMScenarios.POMCreateContact;
...
public class Scenario4 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String fname = elib.getData3FromExcel("problemSheet", 14, 0)+ranNum;
		String lname = elib.getData3FromExcel("problemSheet",10 , 1);
		String parentwin = driver.getWindowHandle();
		POMCreateContact crecon = new POMCreateContact(driver);
		crecon.ClickOnImgPlusContact();
		crecon.FillDataInContact(salutation, fname, lname);
		//wlib.switchtoWindows(driver, "Accounts&action");
		wlib.switchToChildWindowUsingParentWindowandSearchFileToBeClicked(driver, parentwin, oname);
